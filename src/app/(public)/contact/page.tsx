      ...
      <div className="mt-10 grid gap-6 md:grid-cols-3">
        <div className="rounded-xl border border-zinc-200 bg-white p-5">
          ...
          <p className="mt-4 text-sm">
            <a className="underline" href="mailto:admin@example.com">
              admin@example.com
            </a>
          </p>
          <p className="mt-2 text-xs text-zinc-500">
            Replace this with the official alumni email.
          </p>
        </div>
        <div className="rounded-xl border border-zinc-200 bg-white p-5">
          ...
          <p className="mt-4 text-sm text-zinc-900">+234 000 000 0000</p>
          <p className="mt-2 text-xs text-zinc-500">
            Replace this with the official contact number.
          </p>
        </div>
        <div className="rounded-xl border border-zinc-200 bg-white p-5">
